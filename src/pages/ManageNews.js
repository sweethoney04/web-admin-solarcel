...
export default function ManageNews() {
  ...
  return (
    ...
    >
      <div style={{ color: "#154391" }}>ການຈັດການຂ່າວ</div>
    ...
    <div style={{fontFamily: "Noto Sans Lao"}} class="flex justify-between ml-3 mr-2 mt-5">
      <div
        style={{
          width: 250,
          height: 280,
      ...
      >
        ...
        <p style={{marginLeft: 10, marginTop: 10}}>ປະຢັດຄ່າໄຟຟ້າຂອງທ່ານໃນຮູບແບບງ່າຍໆ</p>
        <div style={{marginTop: 25,}} class="flex justify-end">
          <div>
            <button
              style={{
    ...
    <div style={{fontFamily: "Noto Sans Lao"}} class="flex justify-between ml-3 mr-2 mt-5">
      ...
      >
        ...
        <p style={{marginLeft: 5, marginTop: 10,}}>ໃຊ້ພະລັງງານແສງຈາເວັນຈະຄຸ່ມຄ່າຕໍ່ການລົງທຶນທີ່ສຸດ</p>
      ...
      >
        ...
        <p style={{marginLeft: 10, marginRight: 10, marginTop: 10}}> ໂຊລາປ້ຳເຫມາະແກ່ຊາວກະເສດຕະກອນເຮັດໄຮ່ເຮັດສວນເຮັດນາ</p>
        <div style={{marginTop: 0,}} class="flex justify-end">
          <div>
            <button
              style={{
